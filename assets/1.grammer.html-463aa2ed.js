import{_ as l,V as c,W as o,X as s,Y as n,Z as i,$ as a,F as t}from"./framework-8edddef6.js";const p={},d=a(`<h1 id="基本语法" tabindex="-1"><a class="header-anchor" href="#基本语法" aria-hidden="true">#</a> 基本语法</h1><p>Go的基本语法十分简洁且简单，下面通过一个简单的示例来进行讲解。</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> main
