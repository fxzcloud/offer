import{_ as s,V as o,W as c,X as e,Y as n,Z as d,$ as a,F as l}from"./framework-8edddef6.js";const t={},r=e("h1",{id:"模块",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#模块","aria-hidden":"true"},"#"),n(" 模块")],-1),u={href:"https://go.dev/ref/mod",target:"_blank",rel:"noopener noreferrer"},v=a(`<br><h2 id="创建项目" tabindex="-1"><a class="header-anchor" href="#创建项目" aria-hidden="true">#</a> 创建项目</h2><p>有了Go Mod，不再需要将所有的代码都存放在GOPATH目录下，可以在任意位置创建项目，在使用Go Mod之前，需要确保Go Mod已经启用，使用如下命令来查看Go的环境配置</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ go <span class="token function">env</span>
