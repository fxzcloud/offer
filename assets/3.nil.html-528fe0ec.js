import{_ as e,V as t,W as p,X as n,Y as s,Z as o,$ as c,F as i}from"./framework-8edddef6.js";const l={},u=c(`<h1 id="nil" tabindex="-1"><a class="header-anchor" href="#nil" aria-hidden="true">#</a> nil</h1><h2 id="引子" tabindex="-1"><a class="header-anchor" href="#引子" aria-hidden="true">#</a> 引子</h2><p>在一次编写代码的过程中，我需要调用<code>Close()</code>方法来关闭多个对象，就像下面的代码一样</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">type</span> A <span class="token keyword">struct</span> <span class="token punctuation">{</span>
	b B
	c C
   	d D
